...
SMOKE_ID=${FDVLA_EXACT_BATCH4_SMOKE_ID:-20260822_scale60_exact_batch4_col4_v1}
TUNING_ID=${FDVLA_EXACT_BATCH4_TUNING_ID:-20260822_weak1000_exact_batch4_target80_v1}
...
RAY_ROOT=${FDVLA_RAY_ROOT:-/tmp/f4}
...
export SEMANTIC_BATCH_MAX_REQUESTS=4
export SEMANTIC_BATCH_TARGET_REQUESTS=4
...
REPORT=${TUNING_ROOT}/exact_batch4_speed_gate.json
...
report = {
    ...
    "method": "D-PPO-exact-age-configured-batch4-colocated4",
    "train_age_min_frames": int(os.environ["SEMANTIC_TRAIN_RANDOM_AGE_MIN_FRAMES"]),
    "train_age_max_frames": int(os.environ["SEMANTIC_TRAIN_RANDOM_AGE_MAX_FRAMES"]),
